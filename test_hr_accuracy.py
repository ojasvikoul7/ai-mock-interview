#!/usr/bin/env python3
"""
HR Evaluator Accuracy Test Suite
Tests various types of HR answers to verify 90%+ accuracy
"""
...
from backend.ml.hr_evaluator import HREvaluator

def run_tests():
    evaluator = HREvaluator()
    
    test_cases = [
        # EXCELLENT ANSWERS (should score 0.85+)
        {
        ...
        # GOOD ANSWERS (should score 0.70-0.85)
        {
        ...
        # AVERAGE ANSWERS (should score 0.55-0.70)
        {
        ...
        # WEAK ANSWERS (should score below 0.55)
        {
        ...
        # DIFFERENT BUT VALID ANSWERS (should still score well)
        {
    ...
    print("=" * 80)
    print("HR EVALUATOR ACCURACY TEST SUITE")
    print("=" * 80)
    print()
    ...
    if accuracy >= 90:
        print(f"🎉 TARGET ACHIEVED: {accuracy:.1f}% accuracy (target: 90%)")
    else:
        print(f"⚠️  TARGET NOT MET: {accuracy:.1f}% accuracy (target: 90%)")
